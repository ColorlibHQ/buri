(function( $ , api){
    ...
    api.section( 'buri_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'buri_about_section' , function( section ){
    ...
    api.section( 'buri_blog_section' , function( section ){
    ...
    api.section( 'buri_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-buri_contact_custom_formshortcode'),
                selector = $('#_customize-input-buri_contact_formshortcode');
    ...
    // General section
    api.section( 'buri_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#buri_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-buri_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-buri_preloader_color' );
            ...
            var $backtotop          = $( '#buri_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-buri_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-buri_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'buri_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#buri_footer_widget_toggle');
