...
/**
 *
 * buri elementor contact section widget.
 *
 * @since 1.0
 */
class Buri_Contact extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            'info', [
                'label'         => __( 'Create Contact Info', 'buri' ),
                ...
                'fields'  => [
                    [
                        ...
                        'default'     => esc_html__( 'Dhaka, Bangladesh', 'buri' )
                    ],
                    [
                        'name'    => 'desc',
                        'label'   => __( 'Contact Descriptions', 'buri' ),
                        'type'    => Controls_Manager::TEXTAREA,
                        'default' => esc_html__( 'Write something...', 'buri' )
                    ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Icon', 'buri' ),
                        'type'  => Controls_Manager::ICON,
                        'options' => buri_themify_icon()
                    ]
        ...
        $this->start_controls_section(
            'contact_form',
            [
                'label' => __( 'Contact Form', 'buri' ),
            ]
        );
        $this->add_control(
            'contact_form_title',
            [
                'label'     => esc_html__( 'Contact Form Title', 'buri' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Get in Touch', 'buri')
            ]
        );
        $this->add_control(
            'contact_formshortcode',
            [
                'label'     => esc_html__( 'Form Shortcode', 'buri' ),
                'type'      => Controls_Manager::TEXT,
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'color_title', [
                'label'     => __( 'Right Text Title Color', 'buri' ),
        ...
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Right Text Sub Title Color', 'buri' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
