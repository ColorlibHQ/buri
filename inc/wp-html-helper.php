...
// image default alt
if( !function_exists( 'buri_img_default_alt' ) ){
	function buri_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'buri_img_tag' ) ){
	function buri_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'buri_anchor_tag' ) ){
	function buri_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'buri_heading_tag' ) ){
	function buri_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'buri_paragraph_tag' ) ){
	function buri_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'buri_other_tag' ) ){
	function buri_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'buri_button_element ' ) ){
	function buri_button_element( array $args ){
