...
----------------------------------------*/
class buri_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('buri_instagram_photo',esc_html__('[ Buri ] Intagram Photo','buri'),array(
			'description' => esc_html__('Buri Instagram Photo Widget','buri'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'buri');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'buri'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'buri'); ?></label>
...
if(!function_exists('buri_instagram_widgets')):
	function buri_instagram_widgets(){
		register_widget('buri_instagram_photo');
	}
	add_action('widgets_init','buri_instagram_widgets');
endif;
