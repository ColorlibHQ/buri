 ...
 */
	...
	class buri_Enqueue{
		...
		public function buri_scripts_enqueue_init(){
			add_action( 'wp_enqueue_scripts', array( $this, 'buri_frontend_enqueue_scripts', ) );
		}

		public function buri_frontend_enqueue_scripts( ){
